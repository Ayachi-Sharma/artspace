...
export default function InstructorPayoutsPage() {
  ...
  async function handleSaveBank(e) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Could not save bank account");
      }
  ...
  async function handleRequestPayout() {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Could not request payout");
      }
      ...
      >
        ...
        {bankAccount && !showBankForm ? (
          <div>
            ...
            >
              A/C ending in {bankAccount.accountNumberLast4} ·{" "}
              {bankAccount.ifsc}
            </p>
        ...
        >
          ...
          >
            <div>
              ...
              >
                {formatRupees(balance.totalEarned)}
              </div>
            </div>
            ...
            <div>
              ...
              >
                {formatRupees(balance.totalPaidOut)}
              </div>
            </div>
          ...
          {payoutError && (
            <p style={{ color: "red" }}>{payoutError}</p>
          )}
        </div>
      )}
