...
// Drop this into /workshops/[id]/page.tsx in place of the current disabled
// "Book Now" button:
...
export default function BookButton({
      ...
      const rzp = new window.Razorpay({
        ...
        handler: async function (response: any) {
          try {
            ...
            router.push(`/bookings?confirmed=${verifyData.bookingId}`);
          } catch (err: any) {
  ...
  return (
    <div>
      ...
      >
        {soldOut ? "Sold Out" : loading ? "Processing..." : "Book Now"}
      </button>
