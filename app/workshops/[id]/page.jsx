...
export default function WorkshopDetailPage() {
  ...
  const instructor =
    typeof workshop.instructorId === "object"
  ...
  const handleSubmitReview = async (e) => {
    ...
    try {
      ...
      // Refresh the list + summary to include the new review
      loadAll();
    } catch (err) {
          ...
          {reviews.map((r) => {
            ...
            return (
              ...
              >
                ...
                >
                  Experience {r.experience} · Learning{" "}
                  {r.learning} · Ambiance {r.ambiance} ·
